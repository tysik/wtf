...
static char* testCompare() {
    ...
    mu_assert("error, a1 == a2", dcmp(a1, a2) == false);
    mu_assert("error, a1 != a3", dcmp(a1, a3) == true);

    double b1 = 1.0;
    double b2 = 0.99999;
    double b3 = 1.000000001;
    mu_assert("error, b1 == b2", dcmp(b1, b2) == false);
    mu_assert("error, b1 != b3", dcmp(b1, b3) == true);
